//
//  RadioButtonHomeViewController.m
//  CJUIKitDemo
//
...
@interface RadioButtonHomeViewController () <UITableViewDataSource, UITableViewDelegate> {
    
}

@end

@implementation RadioButtonHomeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.navigationItem.title = NSLocalizedString(@"RadioButton首页", nil); //知识点:使得tabBar中的title可以和显示在顶部的title保持各自
...
//    [tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
    ...
    //RadioButton
    {
        ...
        sectionDataModel.theme = @"RadioButton相关";
        {
            CJModuleModel *xibModule = [[CJModuleModel alloc] init];
            xibModule.title = @"CustomButton";
            xibModule.classEntry = [CustomButtonViewController class];
