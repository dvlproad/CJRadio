//
//  PopopButtonsHomeViewController.m
//  CJUIKitDemo
//
...
@interface PopopButtonsHomeViewController () <UITableViewDataSource, UITableViewDelegate> {
    
}

@end

@implementation PopopButtonsHomeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.navigationItem.title = NSLocalizedString(@"PopopButtons首页", nil); //知识点:使得tabBar中的title可以和显示在顶部的title保持各自
...
//    [tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
    ...
    //PopopButtons
    {
        ...
        sectionDataModel.theme = @"PopopButtons相关";
        {
            CJModuleModel *xibModule = [[CJModuleModel alloc] init];
            xibModule.title = @"PopopButtons";
            xibModule.classEntry = [MyRadioButtonsPopupSampleViewController class];
