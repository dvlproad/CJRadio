...
#import "CJRadioPickerView.h"

@interface CJRadioPickerView () <RadioButtonsDataSource, RadioButtonsDelegate, RadioComposeViewDataSource, RadioComposeViewDelegate> {
...
@implementation CJRadioPickerView
