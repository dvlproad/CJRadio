Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dvlproad/RadioButtons.git", :tag => "ButtonControllerView_1.0.4" }
  ...
  s.dependency "RadioButtons", "~> 2.1.5"
  s.dependency "RadioComposeView", "~> 2.1.2"
